    ...
    >
      <div className="flex h-full items-center justify-center">
        <div className="flex flex-col items-start text-center gap-2">
          <h1 className="text-white uppercase text-5xl font-extrabold sm:text-7xl lg:text-9xl">
          ...
          <div className="flex gap-4">
            <button className="bg-white border border-black w-32 text-center text-black rounded-4xl p-2">
              Plan Your Trip
            </button>
            <button className="border w-40 text-center text-white rounded-4xl p-2">
